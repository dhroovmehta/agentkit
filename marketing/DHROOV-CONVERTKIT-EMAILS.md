# ConvertKit Email Sequence — Copy-Paste Ready

> **Instructions for Dhroov:**
>
> **Step A — Create the Sequence:**
> 1. Go to app.kit.com → **Send** → **Sequences** → **New Sequence**
> 2. Name it: "AgentKit Welcome Sequence"
> 3. Copy-paste each email below (subject line + body)
> 4. Set delays between emails as noted (click the delay between emails to edit)
>
> **Step B — Connect the Trigger (separate step):**
> 1. Go to app.kit.com → **Automate** → **Visual Automations** → **New Automation**
> 2. Add trigger: **Subscribes to a form** → select form 9253219 (AgentKit lead magnet)
> 3. Add action: **Email Sequence** → select "AgentKit Welcome Sequence"
> 4. Turn the automation ON (toggle at top right)
>
> **Step C — Find/Replace before publishing:**
> - Replace `[LINK]` with actual URLs (setup guide, product pages, bundle checkout)
> - Replace `[Your Name]` with your chosen anonymous persona name
> - Replace `[DATE]` in Email 5 with a real deadline (e.g., 14 days from sequence start)

---

## EMAIL 1 — Welcome + Setup Tips
**Delay:** Immediately (0 hours)
**Subject Line:** Your Solo Agent is ready. 30-minute setup guide inside.
**Preview Text:** Set up your automation in 30 minutes. I'll walk you through it.
...
**Subject Line:** 3 tweaks that made my agent 10x more useful
**Preview Text:** Small changes in the system prompt = huge differences in what your agent does.
...
**In your prompt, find the Response Style section. Change it to match your actual communication style.**
...
**In your prompt, find the Examples section. Add 2-3 real conversations you want the agent to copy.**
...
**Delay:** 2 days after Email 2 (Day 4 total)
**Subject Line:** How a solo founder went from 60-hour weeks to 30 (using this agent)
**Preview Text:** One template. 15+ hours saved per week. Here's exactly what changed.
...
**Delay:** 3 days after Email 3 (Day 7 total)
**Subject Line:** What comes after you master the free template
**Preview Text:** The paid templates follow the same pattern. Different departments, same architecture.
...
- Solo Founder Bundle (4 templates): $149
- Agency Bundle (5 templates): $199
...
**Subject Line:** Full automation blueprint: 6 templates for $199 (limited time)
**Preview Text:** Save 30% on the bundle. This is the full system I use to run my business.
